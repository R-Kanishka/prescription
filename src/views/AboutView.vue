...
<template>
 ...
 <div class="navbar bg-green">
  ...
  <div class="navbar-center">
    <router-link to="/"><a class="btn btn-ghost normal-case text-xl text-white">Prescription Scanner</a></router-link>
  </div>
    ...
    <div class="container mx-auto items-center justify-center">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <p class="mb-4">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus a libero non tellus posuere pretium.
          </p>
          
          <h2 class="text-2xl font-semibold mb-2">Our Story</h2>
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin vitae bibendum ipsum, ut facilisis nunc.
          </p>
        </div>
