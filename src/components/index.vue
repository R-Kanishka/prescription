...
<template>
  <body class="flex flex-col min-h-screen bg-lowWhite">
 <div class="navbar bg-green">
  ...
  <div class="navbar-center">
    <a class="btn btn-ghost normal-case text-xl text-white">Prescription Scanner</a>
  </div>
  <div class="navbar-end">
  </div>
</div>
<div class="flex items-center justify-center min-h-0 bg-gray-100 pt-32">
  <input type="file" class="file-input file-input-bordered file-input-success w-full max-w-xs" />
 <div class="flex justify-between">
  <span class="m-2"></span>
  <div>
    <button class="btn btn-outline btn-success">Reset</button>
  </div>
  <span class="m-2"></span>
  <div>
    <button class="btn btn-outline btn-success">Generate</button>
 </div>
  </div>
</div>
<span class="m-2"></span>
<div class="flex items-center justify-center min-h-0 bg-gray-100 pt-8">
  <textarea class="textarea textarea-success w-1/3" placeholder=""></textarea>
</div>
...
<footer class="footer items-center p-4 bg-neutral text-neutral-content mt-auto">
  <aside class="items-center grid-flow-col">
    ...
    <p>Prescription Scan system - by Hasitha Wijemuni</p>
  </aside> 
